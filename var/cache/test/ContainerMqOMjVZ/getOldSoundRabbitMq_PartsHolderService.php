...
$a = ($this->services['old_sound_rabbit_mq.emailing_producer'] ?? $this->load('getOldSoundRabbitMq_EmailingProducerService.php'));
$b = ($this->services['old_sound_rabbit_mq.emailing_consumer'] ?? $this->load('getOldSoundRabbitMq_EmailingConsumerService.php'));
