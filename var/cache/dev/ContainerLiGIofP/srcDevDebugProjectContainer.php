...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'console.command.public_alias.App\\Command\\TestConsumerCommand' => 'getTestConsumerCommandService.php',
            'console.command_loader' => 'getConsole_CommandLoaderService.php',
            'filesystem' => 'getFilesystemService.php',
            'old_sound_rabbit_mq.connection.default' => 'getOldSoundRabbitMq_Connection_DefaultService.php',
            'old_sound_rabbit_mq.emailing_consumer' => 'getOldSoundRabbitMq_EmailingConsumerService.php',
            'old_sound_rabbit_mq.emailing_producer' => 'getOldSoundRabbitMq_EmailingProducerService.php',
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'swiftmailer.mailer.default.single_address' => 'memory999@ya.ru',
            ...
            'swiftmailer.single_address' => 'memory999@ya.ru',
            'swiftmailer.mailers' => array(
                'default' => 'swiftmailer.mailer.default',
            ),
            'swiftmailer.default_mailer' => 'default',
            'old_sound_rabbit_mq.base_amqp' => array(
                0 => 'old_sound_rabbit_mq.emailing_producer',
                1 => 'old_sound_rabbit_mq.emailing_consumer',
            ),
            'console.command.ids' => array(
                0 => 'console.command.public_alias.App\\Command\\TestConsumerCommand',
            ),
        );
    }
}
